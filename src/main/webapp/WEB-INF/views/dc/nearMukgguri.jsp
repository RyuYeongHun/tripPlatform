...
<script>
	...
	function addMarker(position, title, contentid, cat1, firstimage, area) {
		...
		if (cat1 == '음식') {
			iwContent = '<a href="https://search.naver.com/search.naver?where=nexearch&sm=top_hty&fbm=0&ie=utf8&query=' + area +' '+ title+'" id="' + contentid
...
<body>
	...
	<div class="coordinate-container">
		...
		검색 반경 <input type="text" id="radius" value="1"> km
		<div>
	...
	<button id="showMap">주변 먹꺼리 찾기</button>
	<button id="myplace">내 위치 먹꺼리</button>
