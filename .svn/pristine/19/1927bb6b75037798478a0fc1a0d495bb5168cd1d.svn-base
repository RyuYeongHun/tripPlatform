				...
				$(".searchCat1").click(
						function(event) {
							...
							$.ajax({
								...
								url : 'http://apis.data.go.kr/B551011/KorService1/categoryCode1?serviceKey=59DlkKuPMMfiNa2kZi8dOfwyWyk6luQkC5Zim5MJJjGavqqvvO5a8WGJnSYdQq0Wj7FnW5a3tZCi96mEbnlohQ==&numOfRows=100&pageNo=1&MobileOS=ETC&MobileApp=AppTest&_type=json',
								type : 'get',
