...
<script>
	...
	//"처리 중" 이미지와 배경을 표시
	  ...
	  document.getElementById('overlay').style.display = 'block';
		...
		$(".url").text(myUrl);
		$.ajax({
			//url : 'http://apis.data.go.kr/B551011/KorService1/areaBasedList1?serviceKey=KyKlcn82QcUpq39lKg0eLESMZb9SG%2BPcmYrQWzSAHY7C2CR0JYlhtyO1Ka5Aam6bU0W5KiXHsJq%2FL9j5y6kbUA%3D%3D&pageNo=1&numOfRows=10&MobileApp=AppTest&MobileOS=ETC&arrange=A&contentTypeId=32&_type=json', // 
...
<div class="content_section">
	...
	<div id="form1">
		...
		serviceKey:<input	id="serviceKey" size=100 value="KyKlcn82QcUpq39lKg0eLESMZb9SG+PcmYrQWzSAHY7C2CR0JYlhtyO1Ka5Aam6bU0W5KiXHsJq/L9j5y6kbUA==" readonly><br>
